...
const TermsPage = () => {
  return (
    <div
      className="min-h-screen text-foreground pt-24 pb-12 px-6 sm:pt-24 sm:pb-12 md:px-12 lg:pt-28 lg:pb-16 lg:px-24"
      dir="rtl"
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <section className="space-y-4">
            ...
            <div className="text-foreground leading-relaxed space-y-3 text-sm sm:text-base">
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="text-foreground leading-relaxed space-y-3 text-sm sm:text-base">
              ...
              <ul className="list-none text-foreground text-sm sm:text-base space-y-2 mr-4">
          ...
          <section className="space-y-4">
            ...
            <div className="text-foreground leading-relaxed space-y-3 text-sm sm:text-base">
              ...
              <ul className="list-disc list-inside text-foreground text-sm sm:text-base space-y-1 mr-4">
