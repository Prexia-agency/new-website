        ...
        >
          ...
          <section className="space-y-4">
            ...
            <div className="text-gray-50 leading-relaxed space-y-3 text-sm sm:text-base">
              ...
              <ul className="list-none text-gray-50 text-sm sm:text-base space-y-2 mr-4">
          ...
          <section className="space-y-4">
            ...
            <div className="text-gray-50 leading-relaxed space-y-3 text-sm sm:text-base">
              ...
              <ul className="list-disc list-inside text-gray-50 text-sm sm:text-base space-y-1 mr-4">
