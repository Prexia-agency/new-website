    ...
    >
      <div className="max-w-6xl mx-auto p-2">
        <div className="flex flex-col gap-3 mb-10">
          <h1 className="font-ppeiko text-3xl md:text-5xl font-normal text-foreground">
            Our blog
          </h1>
        </div>
        ...
        {posts?.length ? (
              ...
              {posts.map((post) => {
                ...
                return (
                  <li key={post._id}>
                    <Link
                      href={href}
                      className="group block hover:bg-white/5 transition-colors"
                    >
                      <div className="py-12 md:py-16 flex flex-col md:flex-row items-start gap-8 md:gap-16">
                        ...
                        <div className="flex-1 flex flex-col gap-6">
                          ...
                          <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {dateText ? (
                              <div className="inline-flex items-center px-3 py-1 rounded-full border border-white/30 text-xs text-foreground">
                                {dateText}
                              </div>
                            ) : null}
                          </div>
                          ...
                          {/* Title */}
                          <h2 className="text-2xl md:text-[24px] lg:text-[28px] font-normal text-foreground leading-tight group-hover:opacity-90 transition-opacity">
                            {post.title || "ללא כותרת"}
                          </h2>

                          {/* Excerpt */}
                          {post.excerpt ? (
                            <p className="text-base md:text-[16px] lg:text-[18px] text-foreground leading-relaxed max-w-xl">
                              {post.excerpt}
                            </p>
                          ) : null}
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-8 text-foreground">
