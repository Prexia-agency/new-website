...
export const metadata: Metadata = {
  title: "צור קשר",
  description:
    "מוכנים להתחיל את הפרויקט הבא שלכם? צרו קשר עם PREXIA - נשמח לשמוע על הרעיון שלכם ולספק פתרונות דיגיטליים מותאמים אישית עם תמיכה מלאה",
  keywords: [
    "צור קשר",
  ...
  twitter: {
    ...
    title: "צור קשר | PREXIA",
    description:
      "בואו נדבר על הפרויקט הבא שלכם - פתרונות דיגיטליים מותאמים אישית",
