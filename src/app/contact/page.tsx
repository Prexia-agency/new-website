    ...
    <div className="min-h-screen pt-24 pb-12 sm:pt-32 sm:pb-12 lg:pt-34 lg:pb-16 bg-black">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        >
          <TitleAnimation
            tag="h1"
            className="text-3xl font-bold font-ppeiko text-gray-50 mb-4 sm:text-3xl lg:text-4xl xl:text-5xl"
            items={titleItems}
            animationName="second"
            controls={titleControls}
          />
          <motion.p
            className="text-sm text-gray-50 max-w-3xl mx-auto leading-relaxed sm:text-sm lg:text-base xl:text-lg"
            initial="initial"
        ...
        >
          ...
          >
            <div className="bg-transparent p-4 sm:p-6 lg:p-8 xl:p-10">
              <h2 className="text-lg font-bold font-noto-hebrew text-gray-50 mb-4 sm:text-xl lg:text-2xl">
              ...
              <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    <label
                      ...
                      className="block text-[12px] font-medium text-gray-50 mb-1 sm:text-sm sm:mb-2"
                    >
                    ...
                    <input
                      ...
                      aria-label="שם מלא"
                      value={formData.name}
                      className={`w-full px-3 py-2 bg-transparent border rounded-[8px] focus:ring-2 focus:border-transparent transition-all duration-200 text-[11px] text-gray-50 sm:text-sm sm:px-4 sm:py-3 ${
                ...
                <div className="relative">
                  <label
                    ...
                    className="block text-[12px] sm:text-sm font-medium text-gray-50 mb-2"
                  >
                  ...
                  <select
                    ...
                    className={`w-full pl-10 pr-3 py-2 bg-transparent border rounded-[8px] focus:ring-2 focus:border-transparent transition-all duration-200 text-[11px] text-gray-50 appearance-none sm:text-sm sm:pl-12 sm:pr-4 sm:py-3 ${
                    ...
                    onBlur={handleBlur}
                  >
                    <option value="" className="bg-black text-gray-50">
                      בחרו סוג פרויקט
                    </option>
                    <option value="website" className="bg-black text-gray-50">
                      אתר אינטרנט
                    </option>
                    <option value="mobile" className="bg-black text-gray-50">
                      אפליקציית נייטיב(למובייל)
                    </option>
                    <option value="web" className="bg-black text-gray-50">
                      אפליקציית ווב
                    </option>
                    <option value="ai" className="bg-black text-gray-50">
                      אוטומציה AI
                    </option>
                    <option value="branding" className="bg-black text-gray-50">
                      Branding
                    </option>
                    <option value="other" className="bg-black text-gray-50">
                      אחר
                    </option>
                  </select>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className={`w-full px-3 py-2 bg-transparent border rounded-[8px] focus:ring-2 focus:border-transparent transition-all duration-200 resize-none text-[11px] text-gray-50 sm:text-sm sm:px-4 sm:py-3 ${
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    className="mt-1 w-4 h-4 text-gray-50 border-white/30 rounded focus:ring-white focus:ring-2 cursor-pointer bg-transparent"
                    required
                    onChange={(e) => setAcceptedTerms(e.target.checked)}
                  />
                  <label
                    htmlFor="acceptTerms"
                    className="text-[11px] sm:text-sm text-gray-50/80 leading-relaxed cursor-pointer"
                  >
                    בשליחת ההודעה אני מאשר/ת שקראתי והבנתי את{" "}
                    <Link
                      href="/privacy"
                      className="text-gray-50 hover:text-gray-50 underline font-medium"
                    >
                      מדיניות הפרטיות
                    </Link>{" "}
                    ואת{" "}
            ...
            >
              <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl shadow-lg p-4 border-2 border-white/20 hover:border-white/30 transition-colors duration-300 group cursor-pointer sm:p-6 lg:p-8">
                ...
                <div className="text-center mb-4 sm:mb-6">
                  ...
                  <h3 className="text-lg font-bold font-noto-hebrew text-gray-50 mb-2 sm:text-xl">
                    צ&apos;אט איתנו בוואטסאפ
                  </h3>
                  <p className="text-gray-50/80 text-xs leading-relaxed sm:text-sm">
                ...
                <div className="text-center">
                  <div className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-gray-50 px-4 py-2 rounded-full font-semibold text-xs transition-all duration-200 sm:px-6 sm:py-3 sm:text-sm">
                    <svg
