...
const pricingData = [
  {
    ...
    description:
      "פתרון מושלם לעסקים הרוצים להקים נוכחות דיגיטלית מקצועית ויעילה",
    features: [
  ...
  },
  {
    ...
    description:
      "חוויית משתמש יוצאת דופן עם אנימציות מתקדמות ואלמנטים אינטראקטיביים",
    features: [
...
const PricingPage = () => {
  ...
  return (
    <div
      className="min-h-screen pt-24 pb-12 sm:pt-24 sm:pb-12 lg:pt-28 lg:pb-16"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        {/* Header Section */}
        <div
          className="text-center mb-16 lg:mb-6 sm:mb-10"
          ref={contentRef}
          dir="rtl"
        >
          ...
          >
            אנחנו מציעים פתרונות אתרים מותאמים אישית לכל עסק, מאתרי תדמית פשוטים
            ועד פרויקטים מורכבים. כל מחיר נקבע לפי הצרכים הספציפיים של הפרויקט
            ומורכבותו הטכנית.
          </motion.p>
        </div>
          ...
          {pricingData.map((plan, index) => (
            ...
            >
              ...
              <div className="flex-grow mb-4 sm:mb-6">
                <h4 className="font-semibold text-gray-900 mb-2 text-[12px] sm:mb-4 sm:text-base">
                  מה כלול בחבילה:
                </h4>
                  ...
                  {plan.features.map((feature, featureIndex) => (
                    ...
                    >
                      <div className="flex-shrink-0 w-4 h-4 bg-green-100 rounded-full flex items-center justify-center mt-0.5 sm:w-5 sm:h-5">
                        <svg
                          className="w-2 h-2 text-green-600 sm:w-3 sm:h-3"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
                      ...
                      <span className="text-gray-700 text-[11px] leading-relaxed sm:text-sm">
                        {feature}
                      </span>
                    </li>
                  ))}
              ...
              <Link
                href="/contact"
                aria-label={`צור קשר לחבילת ${plan.title}`}
