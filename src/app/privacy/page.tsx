...
const PrivacyPage = () => {
  return (
    <div
      className="min-h-screen bg-black text-gray-50 pt-24 pb-12 px-6 sm:pt-24 sm:pb-12 md:px-12 lg:pt-28 lg:pb-16 lg:px-24"
      dir="rtl"
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <section className="space-y-4">
            ...
            <div className="text-gray-50 leading-relaxed space-y-3 text-sm sm:text-base">
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-50 mb-2">
                  2.1 מידע מזהה אישי (PII)
                </h3>
                <p className="text-gray-50 mb-2 text-sm sm:text-base">
                  בעת השימוש באתר או שליחת טופס יצירת קשר אנו עשויים לאסוף את
                  הפרטים הבאים:
                </p>
                <ul className="list-disc list-inside text-gray-50 space-y-1 mr-4 text-sm sm:text-base">
                  <li>שם מלא</li>
                  <li>כתובת דוא&quot;ל</li>
                  <li>מספר טלפון</li>
                  <li>אזרחות</li>
          ...
          <section className="space-y-4">
            ...
            <div className="text-gray-50 space-y-3 text-sm sm:text-base">
              <p>
