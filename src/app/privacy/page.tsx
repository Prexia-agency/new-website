      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">1. כללי</h2>
            <div className="text-white/70 leading-relaxed space-y-3 text-sm sm:text-base">
              <p>
              שירותי PREXIA מופעלים ומנוהלים במסגרת המותג PREXIA.

מדיניות פרטיות זו מתארת כיצד נאסף, נעשה שימוש, נשמר ומוגן מידע אישי במסגרת השימוש באתר PREXIA בכתובת www.prexia.com
 (לרבות כל תת־דומיין הקשור אליו).

לצורכי עמידה בדין, בעלת המאגר והישות המשפטית האחראית לעיבוד המידע היא קיניגמאה בע״מ, חברה הרשומה ופועלת בישראל.

התפעול השוטף של האתר, השירותים, המוצרים והתקשורת מול המשתמשים מתבצע באמצעות PREXIA.
לעניין מדיניות זו, המונח &quot;אנו&quot; מתייחס לחברה, הפועלת באמצעות המותג PREXIA.
              </p>
              <p>
          ...
          {/* Section 2 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">2. סוגי המידע שאנו אוספים</h2>

            <div className="space-y-4">
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">2.1 מידע מזהה אישי (PII)</h3>
                <p className="text-white/70 mb-2 text-sm sm:text-base">בעת השימוש באתר או שליחת טופס יצירת קשר אנו עשויים לאסוף את הפרטים הבאים:</p>
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">2.2 מידע לא אישי</h3>
                <p className="text-white/70 mb-2 text-sm sm:text-base">מידע טכני ושימושי שנאסף אוטומטית, כגון:</p>
                <ul className="list-disc list-inside text-white/70 space-y-1 mr-4 text-sm sm:text-base">
          ...
          {/* Section 3 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">3. הבסיס החוקי לעיבוד מידע (בהתאם ל-GDPR)</h2>
            <p className="text-white/70 text-sm sm:text-base">אנו מעבדים מידע אישי על בסיסים חוקיים אלה:</p>
            <ul className="list-disc list-inside text-white/70 space-y-1 mr-4 text-sm sm:text-base">
          ...
          {/* Section 4 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">4. שימוש במידע שנאסף</h2>
            <p className="text-white/70 text-sm sm:text-base">המידע משמש אותנו למטרות הבאות:</p>
            <ul className="list-disc list-inside text-white/70 space-y-1 mr-4 text-sm sm:text-base">
          ...
          {/* Section 5 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">5. שמירת מידע</h2>
            <p className="text-white/70 text-sm sm:text-base">אנו שומרים את הנתונים לפרקי זמן הבאים:</p>
            <ul className="list-disc list-inside text-white/70 space-y-1 mr-4 text-sm sm:text-base">
          ...
          {/* Section 6 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">6. אחסון ואבטחת מידע</h2>
            <div className="text-white/70 space-y-3 text-sm sm:text-base">
              <p>
                ...
                בין הספקים העיקריים, בין אם במועד זה ובין אם בעתיד:
              </p>
              <ul className="list-disc list-inside text-white/70 space-y-1 mr-4 text-sm sm:text-base">
          ...
          {/* Section 7 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">7. העברת מידע לצדדים שלישיים</h2>
            <div className="text-white/70 space-y-3 text-sm sm:text-base">
...
מידע עשוי להימסר לצדדים שלישיים רק במקרים הבאים:</p>
          ...
          {/* Section 8 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">8. העברת מידע מחוץ לישראל</h2>
          ...
          {/* Section 9 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">9. שימוש בעוגיות ובכלי מעקב</h2>
            <div className="text-white/70 space-y-3 text-sm sm:text-base">
          ...
          {/* Section 10 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">10. ניוזלטרים ותקשורת שיווקית</h2>
            <div className="text-white/70 space-y-3 text-sm sm:text-base">
...
תוכל להסיר את עצמך בכל עת באמצעות:</p>
              <ul className="list-disc list-inside text-white/70 space-y-1 mr-4 text-sm sm:text-base">
                ...
                <li>פנייה לכתובת info@prexia.com
                </li>
              </ul>
            </div>
          </section>
          ...
          {/* Section 11 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">11. זכויותיך (בהתאם ל-GDPR ולחוק הישראלי)</h2>
            <div className="text-white/70 space-y-3 text-sm sm:text-base">
              <p>באפשרותך:</p>
              <ul className="list-disc list-inside text-white/70 space-y-1 mr-4 text-sm sm:text-base">
              ...
              <p>לפנייה בנושא זכויות פרטיות: info@prexia.com
              </p>
          ...
          {/* Section 12 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">12. דיווח על פגיעה בפרטיות</h2>
            <p className="text-white/70 text-sm sm:text-base">
              אם אתה סבור שפרטיותך נפגעה, פנה אלינו מיד לכתובת: info@prexia.com
          ...
          {/* Section 13 */}
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">13. עדכונים למדיניות</h2>
            <p className="text-white/70 text-sm sm:text-base">
