...
const AccessibilityStatement = () => {
  return (
    <div
      className="min-h-screen bg-black pt-24 pb-12 px-6 sm:pt-24 sm:pb-12 md:px-12 lg:pt-28 lg:pb-16 lg:px-24"
      dir="rtl"
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="font-ppeiko text-5xl lg:text-6xl font-light mb-2 mt-15 text-gray-50">
            Accessibility Statement
          </h1>
          <h1 className="font-noto-hebrew text-5xl lg:text-6xl font-black mb-4 text-gray-50">
            הצהרת נגישות
          </h1>
          ...
          <div className="rounded-2xl p-10 space-y-8 prose prose-lg max-w-none">
            <section>
              <div className="bg-white/5 p-6 rounded-lg border-r-4 border-ocean-sky mb-6">
                <p className="text-gray-50 leading-relaxed text-sm sm:text-base mb-4">
                  האתר בכתובת{" "}
                  <strong className="text-gray-50">www.prexia.io</strong> מופעל
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold mb-4 text-gray-50 text-ocean-sky">
                כתובת האתר
              </h2>
              <p className="text-gray-50 leading-relaxed text-sm sm:text-base mb-4">
              ...
              <div className="bg-white/10 p-6 rounded-lg text-center">
                <div className="flex items-center justify-center gap-2 text-2xl font-bold text-peaceful-dawn">
                  <p className="text-gray-50">www.prexia.io</p>
                </div>
              </div>
              <p className="text-gray-50 leading-relaxed text-sm sm:text-base mt-4">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold mb-4 text-gray-50 text-sunset-glow">
                התאמות נגישות שבוצעו באתר
              </h2>
              <p className="text-gray-50 leading-relaxed text-sm sm:text-base mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  >
                    ...
                    <span className="text-gray-50 text-sm sm:text-base">
                      {item.text}
                    </span>
                  </div>
                ))}
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold mb-4 text-gray-50 text-garden-party">
                נגישות פיזית
              </h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold mb-4 text-gray-50 text-rainbow-soft">
              ...
              <div className="mt-4 p-4 bg-white/5 border-r-4 border-sunset-glow rounded-lg">
                <p className="text-gray-50 leading-relaxed text-sm sm:text-base font-medium">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold mb-4 text-gray-50 text-peaceful-dawn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="p-6 bg-white/5 rounded-lg hover:bg-white/10 transition-colors border-r-4 border-ocean-sky">
                  ...
                  <div className="text-gray-50 font-medium">info@prexia.io</div>
                </div>
                ...
                <div className="p-6 bg-white/5 rounded-lg hover:bg-white/10 transition-colors border-r-4 border-peaceful-dawn">
                  ...
                  <div className="text-gray-50 font-medium">050-5322336</div>
                </div>
              </div>

              <div className="bg-white/5 p-6 rounded-lg border-r-4 border-ocean-sky">
                <h3 className="font-semibold text-gray-50 text-lg mb-4">
                  לצורך טיפול יעיל, מומלץ לצרף:
                </h3>
                <ul className="space-y-3 text-gray-50 text-sm sm:text-base">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold mb-4 text-gray-50 text-candy-cloud">
                התחייבות
              </h2>
