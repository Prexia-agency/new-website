...
const hebrewTextsData = [
  { 
    text: 'Accessibility',
    title: 'Accessibility',
    content: 'אתרים העומדים בתקן WCAG 2.1 AA ומבטיחים גישה שווה לכל המשתמשים ללא קשר ליכולותיהם.'
  },
  { 
    text: 'Security',
    title: 'Security',
    content: 'הצפנה מתקדמת, אימות מאובטח ומעקב מתמיד אחר פרצות אבטחה להגנה מלאה.'
  },
  { 
    text: 'Cookies',
  ...
  { 
    ...
    content: 'ארכיטקטורת SEO מיום אחד עם נתונים מובנים, אופטימיזציה של מטא ועוד.'
  },
  { 
    text: 'Performance',
    title: 'Performance',
    content: 'מותאם ל-Core Web Vitals עם זמני טעינה מתחת לשנייה ואינטראקציות חלקות.'
  },
  { 
    text: 'Privacy',
    title: 'Privacy',
    content: 'גישה המעדיפה פרטיות עם טיפול מאובטח בנתונים ובקרות שקופות למשתמש.'
  },
  { 
    text: 'Analytics',
    title: 'Analytics',
    content: 'מעקב ואנליטיקה מתקדמים לקבלת החלטות עסקיות מושכלות המבוססות על נתונים.'
  },
  { 
    text: 'Scalability',
    title: 'Scalability',
    content: 'ארכיטקטורה שתוכננה להתרחב בצורה חלקה מסטארטאפ ועד לרמת ארגון גדול.'
  },
  { 
    text: 'Compliance',
    title: 'Compliance',
    content: 'עמידה מלאה בתקנים בינלאומיים כולל GDPR, ADA ותקנות הענף הרלוונטיות.'
  },
  { 
    text: 'Mobile First',
    title: 'Mobile First',
    content: 'חוויה מושלמת בכל המכשירים עם אינטראקציות מותאמות למגע וממשק רספונסיבי.'
  }
];
...
export default function GalaxySection() {
  ...
  const isMotionDisabled = prefersReducedMotion || !settings.animations || isMotionPaused;
  ...
  return (
    <section className="relative w-full h-[100vh] bg-black -mt-1">
      ...
      <div aria-hidden="true" className="absolute inset-0 flex items-center justify-center pointer-events-none z-15">
          ...
          {hoveredIndex !== null && (
            <div 
              ...
              style={{
                ...
                animation: 'cardOpenFromBottom 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
            ...
            >
              ...
              {/* Hebrew Content */}
              <p className="text-white/90 text-[11px] md:text-sm leading-relaxed text-right mb-6" dir="rtl">
