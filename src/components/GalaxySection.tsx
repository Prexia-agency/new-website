...
const GalaxySection = () => {
  ...
  return (
    <section className="relative w-full h-[100vh] -mt-1">
      ...
      <div className="absolute top-4 right-4 z-20 pointer-events-auto">
        <button
          type="button"
          className="rounded-full border border-white/20 bg-white/10 backdrop-blur-md px-4 py-2 text-xs text-foreground hover:bg-white/15 focus:outline-none focus:ring-2 focus:ring-white/40 disabled:opacity-60 disabled:cursor-not-allowed"
            ...
            (() => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-foreground font-ppeiko text-xl md:text-2xl mb-7 text-left leading-tight">
                    {currentData.title}
                  </h3>

                  {/* Hebrew Content */}
                  <p
                    className="text-foreground text-[11px] md:text-sm leading-relaxed text-right mb-6"
                    dir="rtl"
                  >
                    {currentData.content}
                  </p>
                  ...
                  {/* Footer */}
                  <div className="text-foreground text-[10px] md:text-xs text-left">
                    Learn more →
                  </div>
                </div>
              );
            ...
            hebrewTextsData.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      className="text-foreground/80 font-ppeiko text-lg md:text-xl lg:text-2xl whitespace-nowrap block transition-all duration-300 hover:text-foreground/80"
                      style={{
                        textShadow:
