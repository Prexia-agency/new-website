        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-sm text-gray-300 hover:text-white transition-colors duration-200 lg:text-base">
                  עמוד הבית
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contact" className="text-sm text-gray-300 hover:text-white transition-colors duration-200 lg:text-base">
                  צור קשר
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+972501234567" className="text-sm text-gray-300 hover:text-white transition-colors duration-200 lg:text-base">
                  050-532-2336
                </a>
              </div>
            ...
            {/* Social Media */}
            <div className="mt-6">
              <h5 className="text-xs font-semibold font-noto-hebrew mb-3 text-white lg:text-sm">
                עקבו אחרינו
              </h5>
