      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-4">
            <h2
              className="text-foreground text-3xl sm:text-4xl lg:text-5xl xl:text-6xl leading-tight"
            ...
            <div className="space-y-0">
              {faqData.map((faq, _index) => (
                <div key={faq.id} className="border-t border-white/40">
                  ...
                  >
                    <span
                      className="text-foreground text-sm sm:text-base lg:text-lg font-light pr-4"
                      style={{ fontFamily: "var(--font-ppeiko), sans-serif" }}
                    >
                      {faq.question}
                    </span>
                    <span
                      className="text-foreground text-xl sm:text-2xl font-light transition-all duration-1000"
                      style={{
                        transform:
                          openItem === faq.id
                            ? "rotate(45deg)"
