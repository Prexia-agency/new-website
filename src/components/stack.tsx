      ...
      <div className="max-w-6xl mx-auto px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:gap-8">
        <div className="lg:col-span-6 order-1 lg:order-1" ref={contentRef}>
          <MaskText
            ...
            textClassName="font-noto-hebrew text-[32px] tracking-[-1.12px] text-foreground font-black leading-snug lg:text-[48px] md:text-4xl sm:text-3xl"
            phrases={[
              <>
          ...
          />
          <motion.p
            className="mt-5 max-w-[410px] text-[12.5px] md:mt-3 md:max-w-[470px] sm:mt-2.5 sm:text-base leading-relaxed text-foreground"
            initial="initial"
