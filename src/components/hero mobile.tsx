    ...
    >
      ...
      >
        <div className="flex flex-col items-center">
          <TitleAnimation
            tag="h1"
            className="font-noto-hebrew text-[40px] lg:text-6xl font-black text-foreground mb-1 leading-tight tracking-tight max-w-sm lg:max-w-2xl"
          ...
          <TitleAnimation
            tag="h1"
            className="font-noto-hebrew text-[40px] lg:text-6xl font-black text-foreground mb-4 leading-tight tracking-tight max-w-sm lg:max-w-2xl"
        ...
        <motion.p
          className="text-sm lg:text-[18px] text-foreground/95 mb-8 lg:mb-3 max-w-sm lg:max-w-2xl leading-relaxed font-normal"
          initial="initial"
