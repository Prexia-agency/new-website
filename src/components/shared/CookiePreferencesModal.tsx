        ...
        >
          ...
          <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
            <div className="flex items-center justify-between">
              <h2
                ...
                className="text-2xl font-bold text-peaceful-dawn"
              >
                הגדרות עוגיות
              </h2>
              <button
          ...
          <div className="px-6 py-6 space-y-6">
            ...
            <div className="text-sm text-gray-700 leading-relaxed">
              <p>
                אנו משתמשים בעוגיות כדי לשפר את חוויית הגלישה שלך באתר. עוגיות
                חיוניות נדרשות כדי שהאתר יתפקד כראוי ותמיד פעילות. עוגיות נוספות
                משמשות לניתוח תנועה באתר ולשיפור השירות שלנו.
              </p>
            </div>
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed">
                      עוגיות אלו נחוצות לתפקוד תקין של האתר. הן מאפשרות ניווט
                      בסיסי ושימוש בפונקציות האתר. לא ניתן להשבית עוגיות אלו.
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed">
                      ...
                      המידע נאסף באופן אנונימי ומשמש לשיפור חוויית המשתמש והתוכן
                      באתר.
                    </p>
                  </div>
                  <div className="flex-shrink-0">
                    <button
                      ...
                      aria-label={
                        preferences.analytics
                          ? "השבת עוגיות אנליטיות"
                          : "אפשר עוגיות אנליטיות"
                      }
                      onClick={() =>
                        setPreferences((prev) => ({
                          ...prev,
                ...
                <div className="text-sm text-blue-900">
                  ...
                  <p className="text-blue-800">
                    ...
                    <a
                      href="/privacy"
                      target="_blank"
                      className="underline hover:no-underline mx-1 font-semibold"
                    >
                      מדיניות הפרטיות
                    </a>
                    שלנו.
          ...
          <div className="sticky bottom-0 bg-white border-t border-gray-200 px-6 py-4 rounded-b-2xl">
            <div className="flex flex-col sm:flex-row gap-3 justify-end">
              ...
              <button
                className="px-5 py-2.5 bg-black hover:bg-black/80 text-gray-50 rounded-xl font-bold text-sm transition-colors"
