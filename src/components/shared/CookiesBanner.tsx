        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 lg:gap-4">
            ...
            <div className="flex flex-row lg:flex-col gap-2 lg:gap-4 w-full lg:w-auto pb-2 sm:pb-3">
              <button
                className="flex-1 lg:flex-none bg-black hover:bg-black/80 text-foreground px-3 py-2 lg:px-5 lg:py-3 rounded-[12px] font-bold text-[12px] lg:text-[14px] transition-all duration-200 text-center lg:min-w-[140px]"
