...
import { hasUserMadeChoice, acceptAllCookies, rejectAllCookies } from '@/utils/cookieConsent';
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 lg:gap-4">
            ...
            <div className="flex-1 text-right" dir="rtl">
              ...
              <p className="text-xs text-gray-600">
                עיינו ב
                <Link href="/privacy" className="text-black font-semibold hover:underline mx-1">
                  מדיניות הפרטיות
                </Link>
                וב
                <Link href="/terms" className="text-black font-semibold hover:underline mx-1">
                  תנאי השימוש
                </Link>
                שלנו למידע מפורט.
              </p>
