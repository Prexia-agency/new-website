        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              ...
              <span className="transition-transform duration-300 ease-out group-hover:translate-x-[-2px]">הבית</span>
            </Link>
            <Link
              href="/blog"
              className="group flex items-center gap-2 text-white/90 hover:text-white text-[14px] font-medium transition-all duration-300 ease-out focus:outline-none rounded-md px-3 py-3 hover:bg-white/10 relative overflow-hidden"
            >
              ...
              <span className="transition-transform duration-300 ease-out group-hover:translate-x-[-2px]">בלוג</span>
            </Link>
            <Link
              href="/contact"
              className="group flex items-center gap-2 text-white/90 hover:text-white text-[14px] font-medium transition-all duration-300 ease-out focus:outline-none rounded-md px-3 py-3 hover:bg-white/10 relative overflow-hidden"
            ...
            >
              ...
              <span className="transition-transform duration-300 ease-out group-hover:translate-x-[-2px]">צור קשר</span>
            </Link>
          </div>
