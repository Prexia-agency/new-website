          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          <span className="inline-flex items-center gap-2">
                            <EmailIcon className="h-4 w-4 text-foreground0" />
                        ...
                        >
                          <span className="inline-flex items-center gap-2">
                            <PhoneIcon className="h-4 w-4 text-foreground0" />
            ...
            <div className="border-t border-black/20 pt-6">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-xs text-foreground0 order-2 md:order-1">
                  ירושלים, ישראל
                </p>
                <p
                  className="text-xs text-foreground0 text-center order-1 md:order-2"
                  dir="ltr"
                >
                ...
                <div
                  className="text-xs text-foreground0 order-3 md:order-3"
                  dir="ltr"
                >
                  <span className="relative inline-flex items-center gap-1 group">
                    ...
                    {/* Hover tooltip */}
                    <span className="pointer-events-none absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-md bg-black px-2 py-1 text-[11px] text-foreground opacity-0 shadow-sm transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100">
