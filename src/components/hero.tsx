              ...
              (phrase, index) => (
                ...
                >
                  <motion.h1
                    ...
                    className={`${index === 0 ? "text-left" : "text-right"} font-david-libre text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl text-foreground font-normal leading-tight tracking-tight pb-4`}
            ...
            {[
              ...
              <div key={index} className="overflow-hidden">
                <motion.p
                  ...
                  className="text-md lg:text-lg xl:text-lg text-foreground/95 leading-relaxed font-normal text-center"
                >
                  {phrase}
                </motion.p>
              </div>
      ...
      {showMouseUI && !hasMouseMoved && (
        ...
        >
          <div className="flex flex-col items-center gap-2">
            <p className="text-foreground text-base font-semibold tracking-wide whitespace-nowrap bg-black/30 px-3 py-1 rounded-lg backdrop-blur-sm">
              הזז את העכבר
            </p>
            <svg
              width="20"
