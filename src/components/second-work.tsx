...
const services = [
  {
    id: 1,
    title: 'Web Design',
    descriptionHebrew: 'עיצוב אתרים מותאם אישית, המאזן בין אסתטיקה לבין חוויית משתמש איכותית',
    image: '014.png',
    details: [
  ...
  },
  {
    ...
    descriptionHebrew: 'פיתוח אפליקציות מתקדמות למובייל ווב עם טכנולוגיות חדישות.',
    image: '015.png',
    details: [
  ...
  },
  {
    id: 3,
    title: 'UI/UX Design',
    descriptionHebrew: 'עיצוב ממשקים אינטואיטיביים המבוסס על מחקר משתמשים מעמיק ועקרונות UX',
    image: '016.png',
    details: [
  ...
  },
  {
    id: 4,
    title: 'Branding',
    descriptionHebrew: 'בניית זהות מותגית חזקה ועקבית על פני כל נקודות המגע הדיגיטליות.',
    image: '017.png',
    details: [
  ...
  },
  {
    ...
    descriptionHebrew: 'מימוש אוטומציה של תהליכים חוזרים ונשנים באמצעות טכנולוגיות בינה מלאכותית ותוכנות מתקדמות',
    image: '018.png',
    details: [
      ...
      scrollTriggerRef.current = ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          if (horizontal) {
            ...
            const currentScrollWidth = horizontal.scrollWidth - window.innerWidth;
            const currentExtraSpace = getExtraScrollSpace();
            const totalScrollDistance = currentScrollWidth + delayBuffer + currentExtraSpace;
            const delayThreshold = delayBuffer / totalScrollDistance;
            const adjustedProgress = Math.max(0, Math.min(1, (self.progress - delayThreshold) / (1 - delayThreshold)));
            ...
            cardRefs.current.forEach((card, index) => {
              ...
              if (cardRect.left < windowWidth * 0.8 && cardRect.right > windowWidth * 0.2) {
                ...
                const descriptionLine = description?.querySelector('[data-mask-line]');
                ...
                const bullets = card.querySelectorAll('[data-card-bullet] span');
                ...
                <ul className="space-y-2">
                  {service.details.map((detail, detailIndex) => (
                    <li key={detailIndex} className="flex items-start gap-3">
                      <span className="text-white/50 mt" aria-hidden="true">+</span>
                      <span className="sr-only">{detail}</span>
                      <div className="overflow-hidden flex-1" data-card-bullet data-bullet-index={detailIndex}>
                        <span
