          ...
          >
            ...
            <div className="mb-6 text-left" data-card-heading>
              <div className="overflow-hidden">
                <p className="font-ppeiko text-gray-50 text-3xl md:text-4xl lg:text-5xl leading-tight">
            ...
            <div className="mb-4" dir="rtl" data-card-description>
              ...
              <div className="overflow-hidden">
                <p
                  className="font-noto-hebrew text-gray-50 text-base md:text-lg font-normal leading-relaxed text-right will-change-transform mask-text-initial"
                  aria-hidden="true"
                  data-mask-line
                >
                ...
                <ul className="space-y-2">
                  {service.details.map((detail, detailIndex) => (
                    <li key={detailIndex} className="flex items-start gap-3">
                      <span className="text-gray-50 mt" aria-hidden="true">
                        +
                      </span>
                      ...
                      >
                        <span
                          className="font-noto-hebrew text-gray-50 text-sm md:text-base leading-relaxed inline-block will-change-transform mask-text-initial"
                          aria-hidden="true"
                        >
                          {detail}
                        </span>
